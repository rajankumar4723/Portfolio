...
const projects = [
  ...
  },
  {
    ...
    image: LaptopEc,
    description: "Ecommerce web for notebook built using React.js",
 ...
 
   {
    title: "Timer",
    image: Timer,
    description: "Timer web app with HTML, CSS, JS",
  ...
  },
  {
    title: "Contact Form",
    image: Contact,
    description: "Simple contact form UI using HTML, CSS",
